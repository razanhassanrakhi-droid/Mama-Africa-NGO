...
@section('title', __('massage.dt_add_member') ?? 'Add Team Member')
@section('header', __('massage.dt_add_member') ?? 'Add Team Member')
...
<div class="bg-white p-6 md:p-8 rounded-xl shadow-sm border border-gray-200 focus-within:ring-2 focus-within:ring-blue-100 transition-all max-w-5xl mx-auto">
    <div class="flex items-center justify-between mb-6 pb-4 border-b border-gray-100">
        <h3 class="text-xl font-bold text-gray-800">{{ __('massage.form_member_details') }}</h3>
                ...
                <div class="bg-gray-50 p-4 rounded-lg border border-gray-100">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" name="position[ar]" required class="w-full p-2.5 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white" dir="rtl">
                        </div>
                        <div>
                            ...
                            <input type="text" name="position[en]" required class="w-full p-2.5 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white" dir="ltr">
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gray-50 p-4 rounded-lg border border-gray-100">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" name="role[ar]" required class="w-full p-2.5 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white" dir="rtl">
                        </div>
                        <div>
                            <label class="block text-sm font-semibold mb-1 text-gray-600">{{ __('massage.form_role_en') }} <span class="text-red-500">*</span></label>
                            <input type="text" name="role[en]" required class="w-full p-2.5 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white" dir="ltr">
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gray-50 p-4 rounded-lg border border-gray-100">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <textarea name="message[ar]" rows="3" class="w-full p-2.5 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white" dir="rtl"></textarea>
                        </div>
                        <div>
                            <label class="block text-sm font-semibold mb-1 text-gray-600">{{ app()->getLocale() == 'ar' ? 'الرسالة (إنجليزي)' : 'Message (EN)' }}</label>
                            <textarea name="message[en]" rows="3" class="w-full p-2.5 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white" dir="ltr"></textarea>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="sticky top-6">
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg border border-gray-100">
                        ...
                        <div class="h-64 border-2 border-dashed border-blue-300 rounded-xl flex flex-col justify-center items-center bg-white hover:bg-blue-50 transition cursor-pointer group relative overflow-hidden">
                            ...
                            <div id="placeholder_member_image" class="w-full h-full flex flex-col items-center justify-center p-4 text-center">
                            ...
                            <img id="preview_member_image" class="absolute inset-0 w-full h-full object-cover hidden" />
                            
                            <button id="remove_member_image" type="button" onclick="resetImageUpload('member_image', 'preview_member_image', 'placeholder_member_image', 'remove_member_image', 'hidden_member_image')" class="absolute top-2 right-2 bg-red-500 text-white w-8 h-8 rounded-full flex items-center justify-center hover:bg-red-600 hidden z-20 shadow-md transition-colors" title="Remove Photo">
                    ...
                    <div class="mt-8">
                        <button type="submit" class="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-3.5 px-6 rounded-xl shadow-md hover:shadow-lg transition flex justify-center items-center gap-2">
                            ...
                            <span>{{ __('massage.form_save_member') }}</span>
                        </button>
                    </div>
                </div>
            </div>
