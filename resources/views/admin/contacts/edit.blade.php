        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="email" name="email" value="{{ old('email', $contact->email) }}" class="w-full {{ app()->getLocale() == 'ar' ? 'pr-10 text-left' : 'pl-10 text-left' }} p-2.5 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white" dir="ltr">
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="location_ar" value="{{ old('location_ar', $contact->location_ar) }}" class="w-full {{ app()->getLocale() == 'ar' ? 'pr-10' : 'pl-10' }} p-2.5 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white">
                    </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="location_en" value="{{ old('location_en', $contact->location_en) }}" class="w-full {{ app()->getLocale() == 'ar' ? 'pr-10' : 'pl-10' }} p-2.5 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white" dir="ltr">
                    </div>
            ...
            <div>
                ...
                <textarea name="footer_desc_ar" rows="3" placeholder="تقديم المساعدات الأساسية..." class="w-full p-2.5 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white">{{ old('footer_desc_ar', $contact->footer_desc_ar) }}</textarea>
            ...
            <div>
                ...
                <textarea name="footer_desc_en" rows="3" placeholder="Bringing essential aid..." class="w-full p-2.5 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white" dir="ltr">{{ old('footer_desc_en', $contact->footer_desc_en) }}</textarea>
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="url" name="whatsapp_url" value="{{ old('whatsapp_url', $contact->whatsapp_url) }}" placeholder="https://wa.me/24912345678" class="w-full {{ app()->getLocale() == 'ar' ? 'pr-10 text-left' : 'pl-10 text-left' }} p-2.5 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white" dir="ltr">
                </div>
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="url" name="instagram_url" value="{{ old('instagram_url', $contact->instagram_url) }}" placeholder="https://instagram.com/username" class="w-full {{ app()->getLocale() == 'ar' ? 'pr-10 text-left' : 'pl-10 text-left' }} p-2.5 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white" dir="ltr">
                </div>
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="url" name="linkedin_url" value="{{ old('linkedin_url', $contact->linkedin_url) }}" placeholder="https://linkedin.com/in/username" class="w-full {{ app()->getLocale() == 'ar' ? 'pr-10 text-left' : 'pl-10 text-left' }} p-2.5 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white" dir="ltr">
                </div>
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="url" name="telegram_url" value="{{ old('telegram_url', $contact->telegram_url) }}" placeholder="https://t.me/username" class="w-full {{ app()->getLocale() == 'ar' ? 'pr-10 text-left' : 'pl-10 text-left' }} p-2.5 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white" dir="ltr">
                </div>
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="url" name="x_url" value="{{ old('x_url', $contact->x_url) }}" placeholder="https://x.com/username" class="w-full {{ app()->getLocale() == 'ar' ? 'pr-10 text-left' : 'pl-10 text-left' }} p-2.5 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white" dir="ltr">
                </div>
            ...
            <div class="mt-8 pt-4 border-t border-gray-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="developer_name_ar" value="{{ old('developer_name_ar', $contact->developer_name_ar) }}" class="w-full p-2.5 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white">
                    ...
                    <div>
                        ...
                        <input type="text" name="developer_name_en" value="{{ old('developer_name_en', $contact->developer_name_en) }}" class="w-full p-2.5 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white" dir="ltr">
                    ...
                    <div>
                        ...
                        <input type="url" name="developer_link" value="{{ old('developer_link', $contact->developer_link) }}" class="w-full p-2.5 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white" dir="ltr">
                    ...
                    <div class="md:col-span-2 space-y-4">
                        <div>
                            ...
                            <small class="text-gray-400 mt-1 block">{{ app()->getLocale() == 'ar' ? 'مطلوب فقط عند تغيير شعار المطوّر' : 'Required only when changing developer logo' }}</small>
                        </div>
                        ...
                        <div class="h-40 border-2 border-dashed border-blue-200 rounded-xl flex flex-col justify-center items-center bg-slate-50 hover:bg-white hover:border-blue-400 transition-all cursor-pointer group relative overflow-hidden">
                            ...
                            <div id="devLogoPlaceholder" class="w-full h-full flex flex-col items-center justify-center p-4 text-center {{ $contact->developer_logo ? 'hidden' : '' }}">
                                ...
                                <span class="text-xs font-semibold text-slate-600 group-hover:text-blue-600">{{ app()->getLocale() == 'ar' ? 'رفع شعار جديد' : 'Upload New Logo' }}</span>
                            </div>
                            
                            <img id="devLogoPreview" src="{{ $contact->developer_logo ? url('/media/' . $contact->developer_logo) : '' }}" class="absolute inset-0 w-full h-full object-contain p-4 {{ $contact->developer_logo ? '' : 'hidden' }}" />
                            
                            <button id="removeDevLogoBtn" type="button" onclick="resetImageUpload('dev_logo', 'devLogoPreview', 'devLogoPlaceholder', 'removeDevLogoBtn', 'hidden_dev_logo')" class="absolute top-2 right-2 bg-rose-500 text-white w-7 h-7 rounded-full flex items-center justify-center hover:bg-rose-600 {{ $contact->developer_logo ? '' : 'hidden' }} z-20 shadow-md transition-colors">
                                <i class="fas fa-times text-xs"></i>
                            </button>

                            <input type="hidden" name="cropped_image" id="hidden_dev_logo">
                        </div>
                        <small class="text-gray-500 mt-1 block">{{ app()->getLocale() == 'ar' ? 'اترك حقل الصورة وسؤال الأمان فارغين للاحتفاظ بالشعار الحالي' : 'Leave image and security question empty to keep current logo' }}</small>
                    </div>
                </div>
            </div>
