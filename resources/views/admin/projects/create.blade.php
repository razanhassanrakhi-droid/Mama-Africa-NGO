...
@section('title', __('massage.add_news') ?? 'Add New Project')
@section('header', __('massage.add_news') ?? 'Add New Project')
...
<div class="bg-white p-6 md:p-8 rounded-xl shadow-sm border border-gray-200 focus-within:ring-2 focus-within:ring-blue-100 transition-all max-w-7xl mx-auto">
    <div class="flex items-center justify-between mb-6 pb-4 border-b border-gray-100">
        <h3 class="text-xl font-bold text-gray-800">{{ __('massage.form_project_details') }}</h3>
                ...
                <div class="bg-gray-50 p-4 rounded-lg border border-gray-100">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" name="name[ar]" required placeholder="{{ __('massage.project_name_ar') }}" class="w-full p-2.5 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white" dir="rtl">
                        </div>
                        <div>
                            <label class="block text-sm font-semibold mb-1 text-gray-600">{{ __('massage.form_name_en') }} <span class="text-red-500">*</span></label>
                            <input type="text" name="name[en]" required placeholder="{{ __('massage.project_name_en') }}" class="w-full p-2.5 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white" dir="ltr">
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gray-50 p-4 rounded-lg border border-gray-100">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <textarea name="challange[ar]" required rows="3" placeholder="{{ __('massage.challange_ar') }}" class="w-full p-2.5 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white" dir="rtl"></textarea>
                        </div>
                        <div>
                            ...
                            <textarea name="challange[en]" required rows="3" placeholder="{{ __('massage.challange_en') }}" class="w-full p-2.5 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white" dir="ltr"></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gray-50 p-4 rounded-lg border border-gray-100">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <textarea name="description[ar]" required rows="5" placeholder="{{ __('massage.description_ar') }}" class="w-full p-2.5 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white" dir="rtl"></textarea>
                        </div>
                        <div>
                            ...
                            <textarea name="description[en]" required rows="5" placeholder="{{ __('massage.description_en') }}" class="w-full p-2.5 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white" dir="ltr"></textarea>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="sticky top-6">
                    <div class="bg-gray-50 p-4 rounded-lg border border-gray-100">
                        ...
                        <div class="h-64 border-2 border-dashed border-blue-300 rounded-xl flex flex-col justify-center items-center bg-white hover:bg-blue-50 transition cursor-pointer group relative overflow-hidden">
                            ...
                            <div id="placeholder_project_image" class="w-full h-full flex flex-col items-center justify-center p-4 text-center">
                                ...
                                <span class="text-sm font-semibold text-gray-700 group-hover:text-blue-600">{{ __('massage.image_upload') }}</span>
                                <span class="text-xs text-gray-400 mt-2">PNG, JPG, WEBP up to 2MB</span>
                            </div>
                            
                            <img id="preview_project_image" class="absolute inset-0 w-full h-full object-cover hidden" />
                            
                            <button id="remove_project_image" type="button" onclick="resetImageUpload('project_image', 'preview_project_image', 'placeholder_project_image', 'remove_project_image', 'hidden_project_image')" class="absolute top-2 right-2 bg-red-500 text-white w-8 h-8 rounded-full flex items-center justify-center hover:bg-red-600 hidden z-20 shadow-md transition-colors" title="Remove Image">
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg border border-gray-100 mt-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="icon" placeholder="e.g. fas fa-tint" class="w-full p-2.5 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white" value="{{ old('icon') }}">
                    ...
                    <div class="mt-8">
                        <button type="submit" class="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-3.5 px-6 rounded-xl shadow-md hover:shadow-lg transition flex justify-center items-center gap-2">
                            ...
                            <span>{{ __('massage.form_save_project') }}</span>
                        </button>
                    </div>
                </div>
            </div>
